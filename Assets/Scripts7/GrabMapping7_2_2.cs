...
public class GrabMapping7_2_2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (isMapping)
        {
            ...
            if (curId != lastId)
            {
                ...
                {
                    setTex(QuestionSystem7_2.textures[curId]);
                }
    ...
    int getTexId()
    {
        ...
        int res = (int)((Mathf.Abs(curY - startY) / Mathf.Abs(endY - startY))*QuestionSystem7_2.textures.Length);
