...
public class QuestionSystem7_2 : MonoBehaviour
{
    public int[] questionList;

    public static Texture2D[] textures;

    string localPath = Application.streamingAssetsPath + @"\pics\Series-002";
    FileInfo[] files;
    ...
    public Vector2 cutCenter;//��ͼ����

    public float cutLen;//��ͼ�߳�

    public Camera lookDownCamera;//��������
    ...
    void Start()
    {
        ...
        Vector2 modelOffset = (cutCenter - new Vector2(0.5f, 0.5f)) / cutLen;//ģ��ƫ����
